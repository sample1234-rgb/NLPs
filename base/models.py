...
class Product(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, default='/shop.png')
...
class Order(models.Model):
    ...
    total_price = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
...
class ShippingAddress(models.Model):
    ...
    shipping_price = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
