...
export const PRODUCT_REVIEW_REQUEST = "PRODUCT_REVIEW_ADD_REQUEST";
export const PRODUCT_REVIEW_SUCCESS = "PRODUCT_REVIEW_ADD_SUCCESS";
export const PRODUCT_REVIEW_FAIL = "PRODUCT_REVIEW_ADD_FAIL";
